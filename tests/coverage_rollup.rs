...
// TC-788 (FR-052-AC-10, FR-050-AC-13): the CR-027 criteria rollup — one entry
...
// field would have written — the CR-027 keys are absent, not zero-valued.
#[test]
fn tc788_no_criteria_corpus_is_unchanged() {
    ...
    // The payload is exactly the pre-CR-027 key set.
