...
pub struct CoverageTotals {
    pub backed: usize,
    pub total: usize,
    /// Binding criteria across the corpus (CR-027).
    #[serde(default, skip_serializing_if = "is_zero")]
    pub criteria: usize,
    /// Criteria a generator can extract a property from (CR-027).
    #[serde(default, skip_serializing_if = "is_zero")]
    pub property_shaped: usize,
}

/// A zero CR-027 total, which is omitted from the payload rather than written.
///
