//! Reader-visible prose and project-owned plain-language checks (FR-074).
//!
...
mod tests {
    ...
    fn acronym_first_use_definition_vocabulary_and_code() {
        ...
        let findings = check_plain_language(
            Path::new("a.md"),
            "FR-074 SHALL use API. Service level objective (SLO) is stated. XYZ appears. XYZ repeats. `HID`.",
            &p,
        );
