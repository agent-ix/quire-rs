...
| TC-1870 | `RequiredSections::from_extraction` over a typed `body_extraction` equals `from_dsl` over the authored JSON and over the typed DSL serialized back, and marks exactly the headings of required locators | Integration | P0 | FR-075-AC-11 | ✅ |
