...
| TC-1085 | Export construction refuses each incomplete provenance premise independently — empty repository, moving or abbreviated revision, unnamed/unversioned module, and unavailable schema digest — returning no partial value | Unit | P0 | FR-067-AC-2 | 🚧 |
