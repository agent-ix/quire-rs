...
| TC-807 | Membership is type-driven: typed `tests.md` + untyped `tests.md` + unregistered-type `notes.md` load; frontmatter-less `README.md`/`CHANGELOG.md` are absent and emit no diagnostic (CR-044) | Unit | P0 | FR-024-AC-10 | ✅ |
