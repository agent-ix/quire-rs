...
| TC-804 | A brace or a quote inside a raw string (`r#"…"#`), a lifetime (`&'a str`), a character literal or a nested block comment is content: the file is accepted and yields its symbols — the shape that made 33 of this repo's own source files yield zero symbols (CR-040) | Unit | P0 | FR-051-AC-15 | ✅ |
