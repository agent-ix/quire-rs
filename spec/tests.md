...
| TC-1075 | A reference-only target still resolves declared references and detects dangling ones, while its own rows enter no coverage group, total, minted-target record or authored-obligation population; a tag cannot back it, the omitted posture retains source behavior, and an unknown posture is rejected (#363) | Integration | P0 | FR-050-AC-40, FR-066-AC-2 | ✅ |
