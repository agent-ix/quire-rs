...
| TC-1836 | A table-driven TypeScript lexer test covers regex literals containing escaped `{`, escaped `}`, both braces, `[^}]`, escaped `/`, comment-shaped text, flags, and a regex-shaped template-literal fragment; division and `/=` controls keep following code braces visible. Removing regex state or treating the division controls as regex fails the test. | Unit | P0 | FR-051-AC-25 | 🚧 |
...
| TC-1839 | `filament-core-data@3b75e01c652ba00bb07c352ff5467419401e792b:test/compiler.test.ts` parses from its retained SHA-256 `54c96129e59dab60b37f8ee3107ecd703aa8cf0f864279ff8f49b5be6402074a` blob without source changes, retaining test symbols around the brace-bearing regex at line 1291. | Demonstration | P0 | FR-051-AC-28 | 🚧 |
