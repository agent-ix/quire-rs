...
> **CR-029 note (2026-08-07) — positions 2 and 3 are new, and are the whole of
...
> full result is CR-029 in [the log](../log.md).
...
- ~~**The determiner rule's reach** — the rule is anchored at the start of the
  ...
  **Answered by CR-029 (2026-08-07)**, and answered smaller than this bullet
