...
|----|----------|--------------|
| NFR-020-AC-1 | Static inspection finds no PGlite, Electron, HTTP/auth, CloudManager sync, workspace watcher, or embedding dependencies in the extraction module or bindings. | Inspection (TC-642) |
| NFR-020-AC-2 | A deterministic fixture suite runs the same extraction input repeatedly and observes identical output ordering and record ids. | Test (TC-637) |
| NFR-020-AC-3 | Binding parity fixtures compare Python and WASM output as JSON values, not stringified subprocess payloads. | Test (TC-638) |

## Dependencies

- **Upstream**: [FR-040](../functional/FR-040-filament-core-extraction-engine.md), [FR-041](../functional/FR-041-filament-extraction-bindings.md)
