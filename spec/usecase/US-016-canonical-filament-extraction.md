...
relationships:
  ...
  - target: "ix://agent-ix/quire-rs/spec/stakeholder/StR-005"
    type: "traces_to"
---
# [US-016] Consume canonical Filament extraction from one engine
...
### [US-016-EX-1] IDE worker extracts without Python
...
### [US-016-EX-2] Parser library delegates without drift
...
This story drives [FR-045](../functional/FR-045-filament-core-extraction-engine.md) and
[FR-046](../functional/FR-046-filament-extraction-bindings.md).
